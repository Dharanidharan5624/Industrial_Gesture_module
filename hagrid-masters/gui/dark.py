...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_sidebar(self) -> None:
        ...
        sub_label.setStyleSheet("color: #94a3b8; font-size: 11px; font-weight: 700; margin-bottom: 20px; padding-left: 20px;")
        ...
        self.conn_status.setStyleSheet("color: #16a34a; font-weight: 700; font-size: 11px; padding: 10px; margin: 10px; background-color: #14532d; border-radius: 8px; border: 1px solid #166534;")
    ...
    def _create_dashboard_page(self) -> None:
        ...
        title = QtWidgets.QLabel("Dashboard Summary")
        title.setStyleSheet("font-size: 22px; font-weight: 800; color: #f8fafc;")
        sub_title = QtWidgets.QLabel("Real-time summary of AI inspections, operator metrics, and system status.")
        sub_title.setStyleSheet("color: #94a3b8; font-size: 12px;")
        title_section.addWidget(title)
        title_section.addWidget(sub_title)
        ...
        self.dash_shift_lbl.setStyleSheet("color: #cbd5e1; font-size: 11px; font-weight: 600;")
        ...
        st_title = QtWidgets.QLabel("System Health & Connectivity Indicators")
        st_title.setStyleSheet("font-size: 15px; font-weight: 700; color: #f8fafc;")
        ...
        # CPU/Mem Usage Info
        sys_details = QtWidgets.QLabel("Hardware: CPU Usage: 12% | GPU Temp: 54°C | Memory Usage: 34% (5.4GB / 16.0GB) | SQLite Active")
        sys_details.setStyleSheet("color: #94a3b8; font-size: 12px; font-weight: 500;")
        status_layout.addWidget(sys_details)
    ...
    def _make_badge(self, text: str, status_type: str) -> QtWidgets.QLabel:
        ...
        if status_type == "success":
            lbl.setStyleSheet("background-color: #14532d; color: #16a34a; border: 1px solid #166534; border-radius: 6px; padding: 6px 12px; font-weight: 700; font-size: 11px;")
        elif status_type == "danger":
            lbl.setStyleSheet("background-color: #450a0a; color: #dc2626; border: 1px solid #5c1414; border-radius: 6px; padding: 6px 12px; font-weight: 700; font-size: 11px;")
        else: # warning
            lbl.setStyleSheet("background-color: #451a03; color: #d97706; border: 1px solid #7c4a03; border-radius: 6px; padding: 6px 12px; font-weight: 700; font-size: 11px;")
        return lbl
    ...
    def _create_live_monitor_page(self) -> None:
        ...
        self.sub_title_sop.setStyleSheet("color: #94a3b8; font-size: 12px;")
        title_section.addWidget(title)
    ...
    def _create_operator_page(self) -> None:
        ...
        self.perf_name_lbl.setStyleSheet("font-weight: 700; font-size: 15px; color: #f8fafc;")
        ...
        for lbl in (self.op_login_time, self.op_duration, self.op_break_lbl):
            lbl.setStyleSheet("color: #cbd5e1; font-size: 12px; font-weight: 500;")
    ...
    def _create_analytics_page(self) -> None:
        ...
        rep_title.setStyleSheet("font-size: 15px; font-weight: 700; color: #f8fafc;")
        ...
        hand_lbl.setStyleSheet("font-weight: 600; font-size: 12px; color: #cbd5e1;")
        self.hand_pb = QtWidgets.QProgressBar()
        self.hand_pb.setValue(99)
        self.hand_pb.setStyleSheet("QProgressBar { border: 1px solid #475569; border-radius: 6px; background-color: #0f172a; text-align: center; font-weight: bold; } QProgressBar::chunk { background-color: #10b981; border-radius: 6px; }")
        ...
        gest_lbl.setStyleSheet("font-weight: 600; font-size: 12px; color: #cbd5e1;")
        self.gest_pb = QtWidgets.QProgressBar()
        self.gest_pb.setValue(98)
        self.gest_pb.setStyleSheet("QProgressBar { border: 1px solid #475569; border-radius: 6px; background-color: #0f172a; text-align: center; font-weight: bold; } QProgressBar::chunk { background-color: #8b5cf6; border-radius: 6px; }")
        grid_pb.addWidget(gest_lbl, 1, 0)
        grid_pb.addWidget(self.gest_pb, 1, 1)
        
        tool_lbl = QtWidgets.QLabel("Tool Verification (SIFT + FLANN)")
        tool_lbl.setStyleSheet("font-weight: 600; font-size: 12px; color: #cbd5e1;")
        self.tool_pb = QtWidgets.QProgressBar()
        self.tool_pb.setValue(97)
        self.tool_pb.setStyleSheet("QProgressBar { border: 1px solid #475569; border-radius: 6px; background-color: #0f172a; text-align: center; font-weight: bold; } QProgressBar::chunk { background-color: #2563eb; border-radius: 6px; }")
        grid_pb.addWidget(tool_lbl, 2, 0)
        grid_pb.addWidget(self.tool_pb, 2, 1)
        
        obj_lbl = QtWidgets.QLabel("Object / Part Detection (YOLO)")
        obj_lbl.setStyleSheet("font-weight: 600; font-size: 12px; color: #cbd5e1;")
        self.obj_pb = QtWidgets.QProgressBar()
        self.obj_pb.setValue(96)
        self.obj_pb.setStyleSheet("QProgressBar { border: 1px solid #475569; border-radius: 6px; background-color: #0f172a; text-align: center; font-weight: bold; } QProgressBar::chunk { background-color: #06b6d4; border-radius: 6px; }")
    ...
    def _create_logs_page(self) -> None:
        ...
        self.logs_img_lbl.setStyleSheet("border: 1px dashed #475569; border-radius: 8px; background: #334155; min-height: 250px;")
        self.logs_img_lbl.setWordWrap(True)
        prev_layout.addWidget(self.logs_img_lbl)

        self.logs_details_lbl = QtWidgets.QLabel("")
        self.logs_details_lbl.setStyleSheet("font-size: 12px; color: #cbd5e1;")
        ...
        date_lbl.setStyleSheet("font-weight: 700; font-size: 13px; color: #f8fafc;")
        act_top.addWidget(date_lbl)

        self.activity_file_combo = QtWidgets.QComboBox()
        self.activity_file_combo.setMinimumWidth(220)
        self.activity_file_combo.setStyleSheet("""
            QComboBox {
                background-color: #1e293b;
                border: 1px solid #475569;
                border-radius: 6px;
        ...
        self.activity_count_lbl.setStyleSheet(
            "background-color: #1e3a5f; color: #2563eb; border: 1px solid #1e3a8a; "
        ...
        """)
        search_row = QtWidgets.QHBoxLayout(search_frame)
        ...
        act_layout.addWidget(search_frame)

        # CSV path display
        self.activity_path_lbl = QtWidgets.QLabel("")
        self.activity_path_lbl.setStyleSheet("color: #64748b; font-size: 11px; font-style: italic;")
        ...
        for row_idx, r in enumerate(rows):
            for col_idx, val in enumerate(r[:len(ACTIVITY_COLUMNS)]):
                ...
                if col_idx == 1:  # Event_Type column — colour by type
                    color = type_colors.get(str(val), "#cbd5e1")
    ...
    def _create_tool_page(self) -> None:
        ...
        chk_title.setStyleSheet("font-size: 15px; font-weight: 700; color: #f8fafc;")
        ...
        for r_idx, (p_id, desc, req, status, t_stamp) in enumerate(parts_data):
            ...
            if status == "Correct":
                ...
                status_item.setForeground(QtGui.QColor("#94a3b8"))
    ...
    def _create_reference_page(self) -> None:
        ...
        self.ref_add_panel.setStyleSheet("""
            QFrame#sidebar {
                background-color: #1e293b;
                border-right: 1px solid #334155;
            }
        ...
        panel_title = QtWidgets.QLabel("Add Reference Image")
        panel_title.setStyleSheet("font-size: 15px; font-weight: 800; color: #f8fafc;")
        add_layout.addWidget(panel_title)

        sep = QtWidgets.QFrame()
        sep.setFrameShape(QtWidgets.QFrame.HLine)
        sep.setStyleSheet("background-color: #334155;")
        sep.setFixedHeight(1)
        add_layout.addWidget(sep)
        ...
        add_layout.addWidget(QtWidgets.QLabel("Title:"))
        ...
        add_layout.addWidget(QtWidgets.QLabel("Description:"))
        ...
        add_layout.addWidget(QtWidgets.QLabel("Category:"))
        ...
        add_layout.addWidget(QtWidgets.QLabel("Version:"))
        ...
        # Storage info
        store_info = QtWidgets.QLabel(
            f"Saved to:\nguide/reference_images/"
        )
        store_info.setStyleSheet("color: #64748b; font-size: 10px;")
        store_info.setWordWrap(True)
        add_layout.addWidget(store_info)
        ...
        title_lbl = QtWidgets.QLabel("SOP Reference Image Database")
    ...
    def _ref_rebuild_grid(self) -> None:
        ...
        if count == 0:
            ...
            empty_lbl.setStyleSheet("color: #64748b; font-size: 14px; padding: 60px;")
    ...
    def _ref_make_card(self, entry: dict, idx: int) -> QtWidgets.QFrame:
        ...
        c_title.setStyleSheet("font-weight: 700; font-size: 13px; color: #2563eb;")
        ...
        if img_path and os.path.exists(img_path):
            ...
            if not pix.isNull():
                ...
                img_lbl.setStyleSheet(
                    "border: 1px dashed #7f1d1d; border-radius: 8px;"
                    "background-color: #450a0a; color: #dc2626; font-size: 11px;"
                )
        else:
            img_lbl.setText("No image assigned\nClick 'Set Image'to attach one")
            img_lbl.setStyleSheet(
                "border: 2px dashed #475569; border-radius: 8px;"
                "background-color: #334155; color: #64748b; font-size: 11px;"
            )
        ...
        c_desc.setStyleSheet("color: #cbd5e1; font-size: 11px;")
        ...
        c_ver.setStyleSheet("color: #64748b; font-size: 10px; font-weight: 700;")
        ...
        if path:
            ...
            if not pix.isNull():
                ...
                self.ref_add_preview.setStyleSheet(
                    ...
                    "background-color: #1e3a5f; min-height: 140px;"
                )
            else:
    ...
    def _ref_save_entry(self) -> None:
        ...
        self.ref_add_preview.setStyleSheet(
            ...
            "background-color: #334155; color: #64748b; font-size: 12px; min-height: 140px;"
        )
    ...
    def _zoom_reference_img(self, entry) -> None:
        ...
        img_lbl.setAlignment(Qt.AlignCenter)
        img_lbl.setStyleSheet(
            "border: 1px solid #334155; border-radius: 12px; background-color: #1e293b;"
        )
        ...
        if img_path and os.path.exists(img_path):
            ...
            img_lbl.setStyleSheet(
                ...
                "background-color: #334155; color: #64748b; font-size: 14px; padding: 60px;"
            )
        ...
        if img_path:
            ...
            path_lbl.setStyleSheet("color: #64748b; font-size: 10px;")
    ...
    def _create_settings_page(self) -> None:
        ...
        self.settings_status_lbl.setStyleSheet(
            "background-color: #431407; color: #ea580c; border: 1px solid #7c2d12;"
        ...
        cam_hdr.setStyleSheet(
            ...
            "background-color: #1e3a5f; border-radius: 6px; padding: 6px 10px; margin-top: 6px;"
        )
        ...
        self.active_settings_card.setStyleSheet(
            "QFrame#card { background-color: #14532d; border: 1px solid #166534; border-radius: 10px; }"
        )
        ...
        for lbl in (self.acs_res_lbl, self.acs_rot_lbl, self.acs_conf_lbl, self.acs_sens_lbl):
            lbl.setStyleSheet("color: #4ade80; font-size: 12px; font-weight: 700; background: transparent;")
    ...
    def _load_settings_from_disk(self) -> None:
        ...
        try:
            ...
            self.settings_status_lbl.setStyleSheet(
                "background-color: #14532d; color: #16a34a; border: 1px solid #166534;"
                "border-radius: 10px; padding: 4px 12px; font-size: 11px; font-weight: 700;"
            )
        except Exception as e:
...
class StatCard(QtWidgets.QFrame):
    def __init__(self, label: str, value: str = "--", accent: str = "#2563eb", parent=None):
        ...
        self.label.setStyleSheet("color: #94a3b8; font-size: 10px; font-weight: 700; letter-spacing: 0.5px;")
...
class TrendChart(QtWidgets.QWidget):
    ...
    def paintEvent(self, event) -> None:
        ...
        painter.setPen(QtGui.QPen(QtGui.QColor("#1e293b"), 1.5))
        for x, y in pts:
