...
def run_convert(args):
    ...
    for phase in phases:
        ...
        annotations.progress_apply(lambda row: create_hardlink(row, out_dir, dataset_folder, phase), axis=1)  # type: ignore

        logging.info("Create image_path")
        annotations["image_path"] = annotations.progress_apply(  # type: ignore
