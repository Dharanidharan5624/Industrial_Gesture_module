...
try:
    ...
    try:
        # tensorboard from separate package
        from tensorboard import SummaryWriter  # type: ignore
    except Exception:
        # Fallback dummy writer so importing this module doesn't fail when
        # tensorboard isn't installed. Methods used later will be no-ops.
        class SummaryWriter:  # type: ignore
            def __init__(self, *args, **kwargs):
                print("Warning: TensorBoard unavailable — SummaryWriter disabled")
